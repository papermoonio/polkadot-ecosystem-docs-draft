...
2. Navigate to the **Extrinsics** page
    ...
    ![Access to Developer Extrinsics section](/polkadot-ecosystem-docs-draft/images/build-on-polkadot/parachains/asset-hub/register-a-foreign-asset/register-a-foreign-asset-1.webp)
...
2. Create the extrinsic to register the foreign asset through XCM
    ...
    ![Register foreign asset through XCM](/polkadot-ecosystem-docs-draft/images/build-on-polkadot/parachains/asset-hub/register-a-foreign-asset/register-a-foreign-asset-5.webp)
...
![Asset registration event](/polkadot-ecosystem-docs-draft/images/build-on-polkadot/parachains/asset-hub/register-a-foreign-asset/register-a-foreign-asset-6.webp)
